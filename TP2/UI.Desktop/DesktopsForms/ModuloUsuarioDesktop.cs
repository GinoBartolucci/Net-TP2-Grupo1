...
namespace UI.Desktop
{
    public partial class ModuloUsuarioDesktop : ApplicationForm
    {
        ...
        public ModuloUsuarioDesktop(ModoForm modo) : this()
        {
            Text = modo.ToString();
            Modo = modo;
            ModuloUsuarioActual = new Business.Entities.Modulos_usuarios();
        }
        private Business.Entities.Modulos_usuarios _ModuloUsuarioActual;
        public Business.Entities.Modulos_usuarios ModuloUsuarioActual
        {
        ...
        public ModuloUsuarioDesktop(ModoForm modo, int ID) : this()
        {
            ...
            Modo = modo; ;
            Business.Logic.Modulos_usuariosLogic mul = new Business.Logic.Modulos_usuariosLogic();
            try
            {
